package com.baina.hackathon.httpServer;
...
public class NHttpFileServer {
    ...
    private static HttpServer s_server = null;

    public static void startServer(final String rootPath, int port) throws Exception {
        port = 8080;
...
//        }
    ...
    public static void shutdownServer()
    {
        if (s_server != null)
        {
            s_server.shutdown(5, TimeUnit.SECONDS);
            s_server = null;
        }
    }
